...
- OxideKernels loading `oxide_kernels.cubin` with typed launch wrappers via the oxide bridge module (32 kernels: rmsnorm, silu, silu_glu, attn_output_gate, rope, embedding_gather, add, argmax_bf16, softmax, kv_cache, paged_kv_write, paged_kv_read, gdn_recurrent_step, gdn_gated_delta_prefill, gdn_gated_delta_update, gdn_chunked_gated_delta_prefill, gdn_mamba2_prefill, gdn_mamba2_update, conv1d_depthwise_silu, rms_norm_gated, paged_attention_decode, fp8_quantize, fp8_dequantize, int4_gemm_ksplit, reduce_partial_sums_bf16, int4_dequant_to_bf16, nvfp4_dequant_to_bf16)
